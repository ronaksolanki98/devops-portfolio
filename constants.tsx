...
export const SKILLS: SkillCategory[] = [
  {
    category: "Cloud",
    skills: ["AWS (EC2, RDS, S3, Route 53, Lambda, CloudWatch)", "OCI (Functions, API Gateway, Object Storage, IAM)"]
  },
  {
    category: "DevOps & IaC",
    skills: ["Terraform", "Docker", "Jenkins", "AWS SAM", "GitHub Actions"]
  },
  {
  ...
  },
  {
    ...
    skills: ["CloudWatch", "CloudTrail", "SNS Alerts", "Reliability Engineering"]
  }
];
...
export const PROJECTS: Project[] = [
  {
    ...
    subtitle: "High availability architecture for critical enterprise workloads",
    tech: ["AWS", "Terraform", "EC2", "RDS", "S3", "Route 53", "Lambda", "CloudTrail"],
    problem: [
  ...
  },
  {
    ...
    tech: ["Airflow", "Python", "Docker", "OCI Object Storage", "Oracle Autonomous DB"],
    problem: [
  ...
  },
  {
    ...
    tech: ["AWS Lambda", "DynamoDB", "AWS SAM", "CodePipeline", "CodeBuild"],
    problem: [
